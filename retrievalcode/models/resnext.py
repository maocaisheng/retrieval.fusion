...
from .resnext_features import resnext101_64x4d_features_conv1_4, resnext101_64x4d_features_conv5
...
class ResNeXt101_64x4d(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        #self.num_classes = num_classes
        self.features_conv1_4 = resnext101_64x4d_features_conv1_4
        self.features_conv5 = resnext101_64x4d_features_conv5
        self.avg_pool = nn.AvgPool2d((7, 7), (1, 1))
        #self.last_linear = nn.Linear(2048, num_classes)
    ...
    def forward(self, input):
        x,_ = self.features(input)
        x = self.logits(x)
        return x
    def features(self, x):
        conv4=self.features_conv1_4(x)
        conv5=self.features_conv5(conv4)
        return conv5,conv4
